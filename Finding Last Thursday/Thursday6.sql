...
SELECT SYSDATE
        ,LAST_WEEKDAY() AS RESULT_01 -- IT USES 27-OCT-2022 VALUE (THE DAY I RUN THE QUERY) AND THURSDAY BECAUSE WHEN SECOND PARAMETER SKIPPED IT USES WEEKDAY OF DEFAULT DATE
        ,LAST_WEEKDAY(TO_DATE('17072021' ,'DDMMYYYY')) AS RESULT_02 -- IT USES 17-JUL-2021 AND WEEKDAY OF THIS DATE (SATURDAY)
        ,LAST_WEEKDAY(TO_DATE('17072021' ,'DDMMYYYY') ,'TUESDAY') AS RESULT_03 -- IT USES 17-JUL-2021 AND FINDS THE NEXT AND LAST TUESDAY
        ,LAST_WEEKDAY(V_WEEKDAY_INPUT => 'TUESDAY') AS RESULT_04 -- IT USES 17-JUL-2021 AND FINDS THE NEXT AND LAST TUESDAY
FROM DUAL
;
